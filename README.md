...
First, download the data [here](https://zenodo.org/records/14736486) and move the file `60_cell_lines.tar.gz` to the `data` folder (it should be `./data/60_cell_lines.zip`).
